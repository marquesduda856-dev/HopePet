    ...
    <div className="bg-gray-50 min-h-screen py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-10 shadow-sm border border-gray-100">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Compartilhe sua história</h1>
          <p className="text-gray-600 mb-8">Conte-nos sobre resgates, adoções e finais felizes.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="nome" className="block text-sm font-medium text-gray-700 mb-1">Seu Nome (opcional)</label>
                <input
                  type="text"
                  id="nome"
                  name="nome"
              ...
              <div>
                <label htmlFor="cidade" className="block text-sm font-medium text-gray-700 mb-1">Cidade / Estado *</label>
                <input
                  type="text"
                  id="cidade"
                  name="cidade"
            ...
            <div>
              <label htmlFor="titulo" className="block text-sm font-medium text-gray-700 mb-1">Título da História *</label>
              <input
                type="text"
                id="titulo"
                name="titulo"
            ...
            <div>
              <label htmlFor="historia" className="block text-sm font-medium text-gray-700 mb-1">A História *</label>
              <textarea
                id="historia"
                name="historia"
                required
