    ...
    <div className="bg-gray-50 min-h-screen py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight mb-4">Sobre a HOPE</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Acolhimento</h3>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Proteção</h3>
